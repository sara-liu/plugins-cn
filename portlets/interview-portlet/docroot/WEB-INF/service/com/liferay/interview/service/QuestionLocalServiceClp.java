...
public class QuestionLocalServiceClp implements QuestionLocalService {
	public QuestionLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addQuestionMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addQuestion", com.liferay.interview.model.Question.class);

		_createQuestionMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createQuestion", long.class);

		_deleteQuestionMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteQuestion", long.class);

		_deleteQuestionMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteQuestion", com.liferay.interview.model.Question.class);
		...
		_fetchQuestionMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"fetchQuestion", long.class);

		_getQuestionMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getQuestion", long.class);

		_getPersistedModelMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPersistedModel", java.io.Serializable.class);

		_getQuestionsMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"getQuestions", int.class, int.class);

		_getQuestionsCountMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"getQuestionsCount");

		_updateQuestionMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateQuestion", com.liferay.interview.model.Question.class);

		_updateQuestionMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateQuestion", com.liferay.interview.model.Question.class,
				boolean.class);
	...
	public com.liferay.interview.model.Question addQuestion(
		...
		return (com.liferay.interview.model.Question)ClpSerializer.translateOutput(returnObj);
	}

	public com.liferay.interview.model.Question createQuestion(long questionId) {
		Object returnObj = null;

		MethodHandler methodHandler = new MethodHandler(_createQuestionMethodKey1,
				questionId);
	...
	public com.liferay.interview.model.Question deleteQuestion(long questionId)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteQuestionMethodKey2,
				questionId);
	...
	public com.liferay.interview.model.Question deleteQuestion(
		...
		MethodHandler methodHandler = new MethodHandler(_deleteQuestionMethodKey3,
				ClpSerializer.translateInput(question));
	...
	public com.liferay.interview.model.Question fetchQuestion(long questionId)
		...
		MethodHandler methodHandler = new MethodHandler(_fetchQuestionMethodKey8,
				questionId);
	...
	public com.liferay.interview.model.Question getQuestion(long questionId)
		...
		MethodHandler methodHandler = new MethodHandler(_getQuestionMethodKey9,
				questionId);
	...
	public java.util.List<com.liferay.interview.model.Question> getQuestions(
		...
		MethodHandler methodHandler = new MethodHandler(_getQuestionsMethodKey11,
				start, end);
	...
	public int getQuestionsCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getQuestionsCountMethodKey12);
	...
	public com.liferay.interview.model.Question updateQuestion(
		...
		MethodHandler methodHandler = new MethodHandler(_updateQuestionMethodKey13,
				ClpSerializer.translateInput(question));
	...
	public com.liferay.interview.model.Question updateQuestion(
		...
		MethodHandler methodHandler = new MethodHandler(_updateQuestionMethodKey14,
				ClpSerializer.translateInput(question), merge);
	...
	public void deleteQuestionSetQuestions(long questionSetId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteQuestionSetQuestionsMethodKey18,
				questionSetId);
	...
	private MethodKey _createQuestionMethodKey1;
	private MethodKey _deleteQuestionMethodKey2;
	private MethodKey _deleteQuestionMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _fetchQuestionMethodKey8;
	private MethodKey _getQuestionMethodKey9;
	private MethodKey _getPersistedModelMethodKey10;
	private MethodKey _getQuestionsMethodKey11;
	private MethodKey _getQuestionsCountMethodKey12;
	private MethodKey _updateQuestionMethodKey13;
	private MethodKey _updateQuestionMethodKey14;
